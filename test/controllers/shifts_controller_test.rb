...
class ShiftsControllerTest < ActionController::TestCase
  ...
  test "should create shift" do
    assert_difference('Shift.count') do
      post :create, shift: { end_time: @shift.end_time, name: @shift.name, start_time: @shift.start_time }
    end
  ...
  test "should update shift" do
    patch :update, id: @shift, shift: { end_time: @shift.end_time, name: @shift.name, start_time: @shift.start_time }
    assert_redirected_to shift_path(assigns(:shift))
  end
